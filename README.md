...
<p align="center">
  ...
  <!-- Tests -->
  <img alt="Tests" src="https://img.shields.io/badge/Tests-61_passed-success.svg?logo=pytest" />
...
>- **61 unit tests** — `app/tests/test_protocol.py`, including dedicated tests using byte sequences actually exchanged with the hardware as reference, byte-exact tests transcribed directly from the reference Android app's `At2Commands.kt` for every device-setting command below, and tests for the ack-retry/chunk-pacing message-sending logic and the reassembly edge cases (padded last chunk, missing start frame, out-of-range seq) described below.
