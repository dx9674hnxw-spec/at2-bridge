...
const I18N_DICT = {
  fr: {
    ...
    "map.buildingZonesHint": "Un fichier par zone (voir app/map_buildings/) — coche les zones à afficher directement sur la carte, indépendamment de la « Zone » de visibilité des points d'une couche ci-dessus (qui s'appuie sur les mêmes données).",
  ...
  en: {
    ...
    "map.buildingZonesHint": "One file per zone (see app/map_buildings/) — check the zones to draw directly on the map, separate from a layer's own visibility \"Zone\" above (which draws from the same data).",
