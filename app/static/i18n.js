...
const I18N_DICT = {
  fr: {
    ...
    "settings.basicHint": "Volume et Squelch ont été vérifiés par lecture indépendante sur radio réelle ; VOX communique correctement mais son effet réel reste à confirmer (voir README).",
    "settings.readCurrent": "Lire les réglages actuels",
    "settings.readCurrentTitle": "Relit les réglages confirmés par lecture (mode Serveur uniquement, voir README)",
    ...
    "settings.badgeConfirmed": "✅ Confirmé",
    "settings.badgePending": "⚠️ Non vérifié",
    "settings.badgeWriteOnly": "✍️ Écriture seule",
    ...
    "settings.advancedHint": "Ces réglages sont câblés au protocole réel. « Non vérifié » : la radio répond à la lecture mais l'effet réel n'a pas encore été confirmé. « Écriture seule » : aucune commande de lecture n'existe pour ce réglage. Voir README.",
  ...
  en: {
    ...
    "settings.basicHint": "Volume and Squelch have been verified by independent read-back on real hardware; VOX communicates correctly but its real effect is still unconfirmed (see README).",
    "settings.readCurrent": "Read current settings",
    "settings.readCurrentTitle": "Re-reads the settings confirmed readable (Server mode only, see README)",
    "settings.readResult": "{ok} setting(s) read, {fail} unanswered",
    "settings.reading": "Reading…",
    "settings.readAt": "Last read: {time}",
    "settings.applied": "Setting applied",
    "settings.badgeConfirmed": "✅ Confirmed",
    "settings.badgePending": "⚠️ Unverified",
    "settings.badgeWriteOnly": "✍️ Write-only",
    ...
    "settings.dualWatchFocusA": "Focus A",
    "settings.dualWatchFocusB": "Focus B",
    "settings.advancedHint": "These settings are wired to the real protocol. \"Unverified\": the radio answers the read query but the real effect isn't confirmed yet. \"Write-only\": no read command exists for this setting. See README.",
