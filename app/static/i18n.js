...
const I18N_DICT = {
  fr: {
    ...
    "msg.send": "Envoyer",
    "msg.hint": "Groupes = canaux radio utilisés comme salons de discussion hors-réseau (sélectionner un groupe change le canal actif de la radio). Image/vocal : mode Serveur uniquement pour l'instant.",
  ...
  en: {
    ...
    "msg.send": "Send",
    "msg.hint": "Groups = radio channels used as off-grid chat rooms (selecting a group switches the radio's active channel). Image/voice: Server mode only for now.",
