...
const I18N_DICT = {
  fr: {
    ...
    "map.buildingsToggle": "Bâtiments",
    "map.buildingZonesEmpty": "Aucun contour de bâtiment chargé pour l'instant (voir app/map_buildings/).",
    "map.buildingZonesHint": "Un ou plusieurs fichiers par arrondissement (voir app/map_buildings/) — coche les arrondissements à afficher directement sur la carte, indépendamment de la « Zone » de visibilité des points d'une couche ci-dessus (qui s'appuie sur les mêmes données).",
  ...
  en: {
    ...
    "map.buildingsToggle": "Buildings",
    "map.buildingZonesEmpty": "No building footprints loaded yet (see app/map_buildings/).",
    "map.buildingZonesHint": "One or more files per arrondissement (see app/map_buildings/) — check the arrondissements to draw directly on the map, separate from a layer's own visibility \"Zone\" above (which draws from the same data).",
