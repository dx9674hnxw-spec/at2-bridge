...
const I18N_DICT = {
  fr: {
    ...
    "settings.basicHint": "Voir le README pour le détail testé/non testé sur radio réelle.",
    ...
    "settings.readCurrentTitle": "Relit les réglages depuis la radio (mode Serveur uniquement)",
    ...
    "settings.applyAll": "Appliquer tout",
    ...
    "settings.applyAllLocalOnly": "Mode BLE local : seul le volume a été appliqué (les autres réglages nécessitent le mode Serveur).",
    ...
    "settings.dualWatch": "Dual Watch (veille sur 2 canaux)",
    ...
    "settings.advancedHint": "Ces réglages sont câblés au protocole réel — voir le README pour le détail testé/non testé sur radio physique.",
  ...
  en: {
    ...
    "settings.basicHint": "See the README for what's tested vs. untested on real hardware.",
    ...
    "settings.applyAllLocalOnly": "Local BLE mode: only Volume was applied (the other settings require Server mode).",
    ...
    "settings.dualWatch": "Dual Watch (monitor 2 channels)",
    ...
    "settings.dualWatchFocusA": "Focus A",
    "settings.dualWatchFocusB": "Focus B",
    "settings.advancedHint": "These settings are wired to the real protocol — see the README for what's tested vs. untested on physical hardware.",
